...
- [Finite-state automaton](https://esolangs.org/wiki/Finite-state_automaton) [^re]
- [Gecko](https://esolangs.org/wiki/Gecko) [^re] [^srw]
- [Irregular Expression](https://esolangs.org/wiki/Irregular_Expression) [^re]
- [RegRep](https://esolangs.org/wiki/RegRep) [^re]
- [REGXY](https://esolangs.org/wiki/REGXY) [^re] [^srw]
